Server-based country list
-------------------------

A static list of countries.  I'm keeping this on the server for now,
as opposed to using the hipster front-end JS way of fetching them.
That way means another server hit, which could increase latency of
page load.
